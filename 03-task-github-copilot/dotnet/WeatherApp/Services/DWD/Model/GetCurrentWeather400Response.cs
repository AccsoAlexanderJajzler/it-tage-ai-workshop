...
{
    /// <summary>
    /// GetCurrentWeather400Response
    /// </summary>
    [DataContract(Name = "getCurrentWeather_400_response")]
    public partial class GetCurrentWeather400Response : IEquatable<GetCurrentWeather400Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCurrentWeather400Response" /> class.
        /// </summary>
        /// <param name="title">title.</param>
        /// <param name="description">description.</param>
        public GetCurrentWeather400Response(string title = default(string), string description = default(string))
        {
            Title = title;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCurrentWeather400Response {\n");
        ...
        {
            return Equals(input as GetCurrentWeather400Response);
        }

        /// <summary>
        /// Returns true if GetCurrentWeather400Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCurrentWeather400Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCurrentWeather400Response? input)
        {
            if (input == null)
            {
                return false;
