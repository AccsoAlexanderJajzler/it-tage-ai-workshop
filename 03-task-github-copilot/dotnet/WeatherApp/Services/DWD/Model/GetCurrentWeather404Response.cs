...
{
    /// <summary>
    /// GetCurrentWeather404Response
    /// </summary>
    [DataContract(Name = "getCurrentWeather_404_response")]
    public partial class GetCurrentWeather404Response : IEquatable<GetCurrentWeather404Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCurrentWeather404Response" /> class.
        /// </summary>
        /// <param name="title">title.</param>
        /// <param name="description">description.</param>
        public GetCurrentWeather404Response(string title = default(string), string description = default(string))
        {
            Title = title;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCurrentWeather404Response {\n");
        ...
        {
            return Equals(input as GetCurrentWeather404Response);
        }

        /// <summary>
        /// Returns true if GetCurrentWeather404Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCurrentWeather404Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCurrentWeather404Response? input)
        {
            if (input == null)
            {
                return false;
