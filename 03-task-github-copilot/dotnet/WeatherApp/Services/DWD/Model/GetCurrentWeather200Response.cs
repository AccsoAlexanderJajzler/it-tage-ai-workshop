...
{
    /// <summary>
    /// GetCurrentWeather200Response
    /// </summary>
    [DataContract(Name = "getCurrentWeather_200_response")]
    public partial class GetCurrentWeather200Response : IEquatable<GetCurrentWeather200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCurrentWeather200Response" /> class.
        /// </summary>
        /// <param name="weather">weather.</param>
        /// <param name="sources">sources.</param>
        public GetCurrentWeather200Response(GetCurrentWeather200ResponseWeather weather = default(GetCurrentWeather200ResponseWeather), List<Source> sources = default(List<Source>))
        {
            Weather = weather;
            Sources = sources;
        }
        ...
        public GetCurrentWeather200ResponseWeather Weather { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCurrentWeather200Response {\n");
        ...
        {
            return Equals(input as GetCurrentWeather200Response);
        }

        /// <summary>
        /// Returns true if GetCurrentWeather200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCurrentWeather200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCurrentWeather200Response? input)
        {
            if (input == null)
            {
                return false;
