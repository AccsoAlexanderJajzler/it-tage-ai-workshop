...
namespace Service.DWD.Model
{
    ...
    /// GetRadar200Response
    /// </summary>
    [DataContract(Name = "getRadar_200_response")]
    public partial class GetRadar200Response : IEquatable<GetRadar200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRadar200Response" /> class.
        /// </summary>
        /// <param name="radar">radar.</param>
        /// <param name="geometry">GeoJSON-formatted bounding box of returned radar data, i.e. lat/lon coordinates of the four corners..</param>
        /// <param name="bbox">Bounding box (top, left, bottom, right) calculated from the supplied position and distance. Only returned if you supplied &#x60;lat&#x60; and &#x60;lon&#x60;..</param>
        /// <param name="latlonPosition">Exact x-y-position of the supplied position. Only returned if you supplied &#x60;lat&#x60; and &#x60;lon&#x60;..</param>
        public GetRadar200Response(List<Radar> radar = default(List<Radar>), Object geometry = default(Object), List<int> bbox = default(List<int>), Object latlonPosition = default(Object))
        {
            Radar = radar;
            Geometry = geometry;
            Bbox = bbox;
        ...
        /// </summary>
        /// <value>GeoJSON-formatted bounding box of returned radar data, i.e. lat/lon coordinates of the four corners.</value>
        ...
        /// </summary>
        /// <value>Bounding box (top, left, bottom, right) calculated from the supplied position and distance. Only returned if you supplied &#x60;lat&#x60; and &#x60;lon&#x60;.</value>
        ...
        /// </summary>
        /// <value>Exact x-y-position of the supplied position. Only returned if you supplied &#x60;lat&#x60; and &#x60;lon&#x60;.</value>
        [DataMember(Name = "latlon_position", EmitDefaultValue = true)]
        public Object LatlonPosition { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetRadar200Response {\n");
            sb.Append("  Radar: ").Append(Radar).Append("\n");
            sb.Append("  Geometry: ").Append(Geometry).Append("\n");
            sb.Append("  Bbox: ").Append(Bbox).Append("\n");
            sb.Append("  LatlonPosition: ").Append(LatlonPosition).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return Equals(input as GetRadar200Response);
        }

        /// <summary>
        /// Returns true if GetRadar200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetRadar200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetRadar200Response? input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    ...
                    Radar != null &&
                    input.Radar != null &&
                    Radar.SequenceEqual(input.Radar)
                ) && 
                (
                ...
                (
                    LatlonPosition == input.LatlonPosition ||
                    (LatlonPosition != null &&
                    LatlonPosition.Equals(input.LatlonPosition))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (Radar != null)
                {
                    hashCode = (hashCode * 59) + Radar.GetHashCode();
                }
                if (Geometry != null)
                {
                ...
                {
                    hashCode = (hashCode * 59) + LatlonPosition.GetHashCode();
                }
                return hashCode;
            }
        }
