...
namespace Service.DWD.Model
{
    ...
    /// GetRadar404Response
    /// </summary>
    [DataContract(Name = "getRadar_404_response")]
    public partial class GetRadar404Response : IEquatable<GetRadar404Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRadar404Response" /> class.
        /// </summary>
        /// <param name="title">title.</param>
        /// <param name="description">description.</param>
        public GetRadar404Response(string title = default(string), string description = default(string))
        {
            Title = title;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetRadar404Response {\n");
        ...
        {
            return Equals(input as GetRadar404Response);
        }

        /// <summary>
        /// Returns true if GetRadar404Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetRadar404Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetRadar404Response? input)
        {
            if (input == null)
            {
                return false;
