...
{
    /// <summary>
    /// GetCurrentWeather200ResponseWeatherAllOf
    /// </summary>
    [DataContract(Name = "getCurrentWeather_200_response_weather_allOf")]
    public partial class GetCurrentWeather200ResponseWeatherAllOf : IEquatable<GetCurrentWeather200ResponseWeatherAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCurrentWeather200ResponseWeatherAllOf" /> class.
        /// </summary>
        ...
        public GetCurrentWeather200ResponseWeatherAllOf(Object fallbackSourceIds = default(Object))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCurrentWeather200ResponseWeatherAllOf {\n");
        ...
        {
            return Equals(input as GetCurrentWeather200ResponseWeatherAllOf);
        }

        /// <summary>
        /// Returns true if GetCurrentWeather200ResponseWeatherAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCurrentWeather200ResponseWeatherAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCurrentWeather200ResponseWeatherAllOf? input)
        {
            if (input == null)
            {
                return false;
