...
namespace Service.DWD.Model
{
    ...
    /// SynopRecord
    /// </summary>
    [DataContract(Name = "SynopRecord")]
    public partial class SynopRecord : IEquatable<SynopRecord>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SynopRecord" /> class.
        /// </summary>
        ...
        /// <param name="sunshine10">Sunshine duration during previous 10 minutes.</param>
        public SynopRecord(DateTime timestamp = default(DateTime), int sourceId = default(int), decimal? cloudCover = default(decimal?), ConditionEnum? condition = default(ConditionEnum?), decimal? dewPoint = default(decimal?), IconEnum? icon = default(IconEnum?), decimal? precipitation10 = default(decimal?), decimal? precipitation30 = default(decimal?), decimal? precipitation60 = default(decimal?), decimal? pressureMsl = default(decimal?), int? relativeHumidity = default(int?), decimal? solar10 = default(decimal?), decimal? solar30 = default(decimal?), decimal? solar60 = default(decimal?), decimal? sunshine30 = default(decimal?), decimal? sunshine60 = default(decimal?), decimal? temperature = default(decimal?), int? visibility = default(int?), int? windDirection10 = default(int?), int? windDirection30 = default(int?), int? windDirection60 = default(int?), decimal? windSpeed10 = default(decimal?), decimal? windSpeed30 = default(decimal?), decimal? windSpeed60 = default(decimal?), int? windGustDirection10 = default(int?), int? windGustDirection30 = default(int?), int? windGustDirection60 = default(int?), decimal? windGustSpeed10 = default(decimal?), decimal? windGustSpeed30 = default(decimal?), decimal? windGustSpeed60 = default(decimal?), decimal? sunshine10 = default(decimal?))
        {
            Timestamp = timestamp;
            SourceId = sourceId;
        ...
        /// </summary>
        /// <value>Sunshine duration during previous 10 minutes</value>
        [DataMember(Name = "sunshine_10", EmitDefaultValue = true)]
        public decimal? Sunshine10 { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Sunshine10: ").Append(Sunshine10).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return Equals(input as SynopRecord);
        }

        /// <summary>
        /// Returns true if SynopRecord instances are equal
        /// </summary>
        /// <param name="input">Instance of SynopRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SynopRecord? input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    Sunshine10 == input.Sunshine10 ||
                    (Sunshine10 != null &&
                    Sunshine10.Equals(input.Sunshine10))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (Sunshine10 != null)
                {
                    hashCode = (hashCode * 59) + Sunshine10.GetHashCode();
                }
                return hashCode;
            }
        }
