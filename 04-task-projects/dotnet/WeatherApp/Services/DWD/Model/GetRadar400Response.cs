...
namespace Service.DWD.Model
{
    ...
    /// GetRadar400Response
    /// </summary>
    [DataContract(Name = "getRadar_400_response")]
    public partial class GetRadar400Response : IEquatable<GetRadar400Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRadar400Response" /> class.
        /// </summary>
        /// <param name="title">title.</param>
        /// <param name="description">description.</param>
        public GetRadar400Response(string title = default(string), string description = default(string))
        {
            Title = title;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetRadar400Response {\n");
        ...
        {
            return Equals(input as GetRadar400Response);
        }

        /// <summary>
        /// Returns true if GetRadar400Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetRadar400Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetRadar400Response? input)
        {
            if (input == null)
            {
                return false;
