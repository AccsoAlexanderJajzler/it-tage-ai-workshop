...
namespace Service.DWD.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getSources_200_response")]
    public partial class GetSources200Response : IEquatable<GetSources200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSources200Response" /> class.
        /// </summary>
        /// <param name="sources">sources.</param>
        public GetSources200Response(List<Source> sources = default(List<Source>))
        {
            Sources = sources;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSources200Response {\n");
        ...
        {
            return Equals(input as GetSources200Response);
        }

        /// <summary>
        /// Returns true if GetSources200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetSources200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSources200Response? input)
        {
            if (input == null)
            {
                return false;
