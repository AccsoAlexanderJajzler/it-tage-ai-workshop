...
namespace Service.DWD.Model
{
    ...
    /// SynopRecordAllOf
    /// </summary>
    [DataContract(Name = "SynopRecord_allOf")]
    public partial class SynopRecordAllOf : IEquatable<SynopRecordAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SynopRecordAllOf" /> class.
        /// </summary>
        /// <param name="sunshine10">Sunshine duration during previous 10 minutes.</param>
        public SynopRecordAllOf(decimal? sunshine10 = default(decimal?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SynopRecordAllOf {\n");
        ...
        {
            return Equals(input as SynopRecordAllOf);
        }

        /// <summary>
        /// Returns true if SynopRecordAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SynopRecordAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SynopRecordAllOf? input)
        {
            if (input == null)
            {
                return false;
