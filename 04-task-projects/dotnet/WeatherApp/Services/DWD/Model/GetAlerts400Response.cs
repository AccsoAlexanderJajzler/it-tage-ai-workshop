...
{
    /// <summary>
    /// GetAlerts400Response
    /// </summary>
    [DataContract(Name = "getAlerts_400_response")]
    public partial class GetAlerts400Response : IEquatable<GetAlerts400Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAlerts400Response" /> class.
        /// </summary>
        /// <param name="title">title.</param>
        /// <param name="description">description.</param>
        public GetAlerts400Response(string title = default(string), string description = default(string))
        {
            Title = title;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAlerts400Response {\n");
        ...
        {
            return Equals(input as GetAlerts400Response);
        }

        /// <summary>
        /// Returns true if GetAlerts400Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAlerts400Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAlerts400Response? input)
        {
            if (input == null)
            {
                return false;
